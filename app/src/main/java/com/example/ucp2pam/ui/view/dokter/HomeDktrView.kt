...
import com.example.ucp2pam.ui.viewmodel.dokter.HomeUiStateDokter
            ...
            Row(
                ...
                Text(
                    ...
                    color = when (dktr.spesialis){
                        "Dokter spesialis Jantung" -> colorResource(id = R.color.jantung_color)
                        "Dokter spesialis Anak" -> colorResource(id = R.color.anak_color)
                        "Dokter spesialis Kulit" -> colorResource(id = R.color.kulit_color)
